...
public class Enemy : MonoBehaviour
{
    ...
    //fungsi terpanggil sekali ketika setiap kali menghidupkan game object yg memiliki script ini
    ...
    //menghapus object enemy ketika hp habis
    ...
    //menandai index akhir pada path
